...
@Test
  ...
  public void getListBasedOnTrendTest1() {
    ...
    assertEquals("Testing getListBasedOnTrend first country ", "Yemen",
        newList.get(0));
    assertEquals("Testing getListBasedOnTrend 2nd country ", "Ghana",
        newList.get(1));
...
@Test
  ...
  public void getListBasedOnTrendTest2() {
    ...
    assertEquals("Testing getListBasedOnTrend size", 2, newList.size());
    assertEquals("Testing getListBasedOnTrend first country ", "Togo",
        newList.get(0));
    assertEquals("Testing getListBasedOnTrend 2nd country ", "Sudan",
        newList.get(1));
    assertEquals("Testing getListBasedOnTrend size old list", 6, listCountries.size());
...
@Test
 public void addDataPointTest2() {
  System.out.println("addDataPointTest2");
  ArrayList<Country> listCountries = new ArrayList<Country>();
  Integer[] years = { 2021, 2022, 2023, 2024, 2025 };
  Double[][] data = { { 36.81818182, 36.81818181, 30.45454545, 30.454, 29.2 }, // down
    { 43.4, 44.5, 45.6, 47.7, 350.2 }, // up
  ...
  listCountries.get(0).addDataPoint(2027, 4242);
  assertEquals("Testing # years for first country", 6, listCountries.get(0).getYears().size());
  assertEquals("Testing # years for second country", 5, listCountries.get(1).getYears().size());
 }
